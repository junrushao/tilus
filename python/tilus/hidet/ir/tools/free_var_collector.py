...
try:
    from tilus.hidet.ir.compute import ArgReduceCompute, GridCompute, ReduceCompute
except ImportError:
    GridCompute = ReduceCompute = ArgReduceCompute = None
from tilus.hidet.ir.functors import IRVisitor
from tilus.hidet.ir.stmt import DeclareStmt, ForStmt, LetStmt, SeqStmt, Stmt
