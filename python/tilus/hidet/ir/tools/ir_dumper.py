...
from tilus.hidet.ir.functors.ir_functor import IRFunctor
...
from tilus.hidet.ir.primitives.func import is_primitive_function, lookup_primitive_function
...
from tilus.hidet.utils.doc import Doc, NewLine, Text, doc_join
from tilus.hidet.utils.namer import Namer
...
class ParseTreeVisitor:
    ...
    def visit_call_expr(self, node):
        from tilus.hidet.ir.primitives.func import PrimitiveFunctionRegistry
...
class IRConstructor(ParseTreeVisitor):
    ...
    def visit_var(self, node):
        from tilus.hidet.lang.cuda import blockDim, blockIdx, gridDim, threadIdx
...
def diff_text(old: str, new: str):
    from tilus.hidet.utils.py import green, red
